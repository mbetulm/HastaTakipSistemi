...
/**
 * Created by BETUL MURA on 6.3.2018.
 */
...
public class CustomTimePickerDialog extends android.app.TimePickerDialog {
    ...
    public CustomTimePickerDialog(Context context, OnTimeSetListener listener, int hourOfDay, int minute, boolean is24HourView) {
        super(context, CustomTimePickerDialog.THEME_HOLO_LIGHT, null, hourOfDay, minute/TIME_PICKER_INTERVAL, is24HourView);
    ...
    public void onAttachedToWindow() {
        ...
        try {
            ...
            final NumberPicker hourSpinner = (NumberPicker) mTimePicker.findViewById(field2.getInt(null));
